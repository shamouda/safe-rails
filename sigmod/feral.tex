...
problems since you turned it
off.''\footnote{\url{https://github.com/spree/spree/issues/3238#issuecomment-20035900}}. Thus,
the choice of (and even use of) concurrency control is 
sometimes an ad-hoc process.
